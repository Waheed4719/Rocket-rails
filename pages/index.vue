...
import TransistorLogo from "@/assets/images/transistor.svg";
import TupleLogo from "@/assets/images/tuple.svg";
import StaticKitLogo from "@/assets/images/statickit.svg";
import MirageLogo from "@/assets/images/mirage.svg";
import LaravelLogo from "@/assets/images/laravel.svg";
import StatamicLogo from "@/assets/images/statamic.svg";
import TaxpalImage from "@/assets/images/taxpal.webp";
import ProfitLossImage from "@/assets/images/profit-loss.webp";
...
<template>
  ...
  <div class="bg-white">
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <nav class="relative z-50 flex justify-between">
          <div class="flex items-center md:gap-x-12">
            <nuxt-link aria-label="Home" to="/" class="text-lg">
              🚀 Rocket Rails
            </nuxt-link>
            ...
            <div class="-mr-1 md:hidden">
              <div data-headlessui-state>
                <button
                  ...
                  id="headlessui-popover-button-:R1sm:"
                >
                  <svg
                    aria-hidden="true"
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
          ...
          >
              ...
              >
                ...
                >
                  <h3>
                    <button
                      ...
                      id="headlessui-tabs-tab-:R2ja76:"
                      role="tab"
                      type="button"
                      aria-selected="false"
                      tabIndex="{-1}"
                      data-headlessui-state
                      aria-controls="headlessui-tabs-panel-:Rla76:"
                    >
                      <span
                        class="absolute inset-0 rounded-full lg:rounded-l-xl lg:rounded-r-none"
                      />
                ...
                >
                  <h3>
                    <button
                      class="font-display text-lg [&:not(:focus-visible)]:focus:outline-none text-blue-100 hover:text-white lg:text-white"
                      id="headlessui-tabs-tab-:R2ra76:"
                      role="tab"
                      type="button"
                      aria-selected="false"
                      tabIndex="{-1}"
                      data-headlessui-state
                      aria-controls="headlessui-tabs-panel-:Rta76:"
                    >
                      <span
                        class="absolute inset-0 rounded-full lg:rounded-l-xl lg:rounded-r-none"
                      />
                ...
                >
                  <h3>
                    <button
                      class="font-display text-lg [&:not(:focus-visible)]:focus:outline-none text-blue-100 hover:text-white lg:text-white"
                      id="headlessui-tabs-tab-:R33a76:"
                      role="tab"
                      type="button"
                      aria-selected="false"
                      tabIndex="{-1}"
                      data-headlessui-state
                      aria-controls="headlessui-tabs-panel-:R15a76:"
                    >
                      <span
                        class="absolute inset-0 rounded-full lg:rounded-l-xl lg:rounded-r-none"
                      />
            ...
            <div class="lg:col-span-7">
              ...
              <div
                id="headlessui-tabs-panel-:Rla76:"
                role="tabpanel"
                tabIndex="{-1}"
                hidden
                style="
                ...
                "
                data-headlessui-state
                aria-labelledby="headlessui-tabs-tab-:R2ja76:"
              >
                <div class="relative sm:px-6 lg:hidden">
                  <div
                    class="absolute -inset-x-4 bottom-[-4.25rem] top-[-6.5rem] bg-white/10 ring-1 ring-inset ring-white/10 sm:inset-x-0 sm:rounded-t-xl"
              ...
              <div
                id="headlessui-tabs-panel-:R15a76:"
                role="tabpanel"
                tabIndex="{-1}"
                hidden
                style="
            ...
            <div>
              <div class="mx-auto max-w-2xl">
                <div class="w-9 rounded-lg bg-blue-600">
                  <svg aria-hidden="true" class="h-9 w-9" fill="none" style="">
                    <defs>
                      <linearGradient
                        id=":Raredja:"
                        x1="11.5"
          ...
          <div class="hidden lg:mt-20 lg:block">
            ...
            >
              ...
              <div class="relative opacity-75 hover:opacity-100">
                ...
                <h3 class="mt-6 text-sm font-medium text-slate-600">
                  <button
                    class="[&:not(:focus-visible)]:focus:outline-none"
                    id="headlessui-tabs-tab-:Rkr96:"
                    role="tab"
                    type="button"
                    aria-selected="false"
                    tabIndex="{-1}"
                    data-headlessui-state
                    aria-controls="headlessui-tabs-panel-:Rjb96:"
                  >
                    <span class="absolute inset-0" />
                    Inventory
                  </button>
              ...
              <div class="relative opacity-75 hover:opacity-100">
                ...
                <h3 class="mt-6 text-sm font-medium text-slate-600">
                  <button
                    class="[&:not(:focus-visible)]:focus:outline-none"
                    id="headlessui-tabs-tab-:Rmr96:"
                    role="tab"
                    type="button"
                    aria-selected="false"
                    tabIndex="{-1}"
                    data-headlessui-state
                    aria-controls="headlessui-tabs-panel-:Rrb96:"
                  >
                    <span class="absolute inset-0" />
                    Contacts
                  </button>
            ...
            >
              <div class="-mx-5 flex">
                ...
                <div
                  class="px-5 transition duration-500 ease-in-out [&:not(:focus-visible)]:focus:outline-none opacity-60"
                  style="
                     {
                  ...
                  "
                  aria-hidden="true"
                  id="headlessui-tabs-panel-:Rjb96:"
                  role="tabpanel"
                  tabIndex="{-1}"
                  data-headlessui-state
                  aria-labelledby="headlessui-tabs-tab-:Rkr96:"
                >
                  <div
                    class="w-[52.75rem] overflow-hidden rounded-xl bg-white shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10"
                  >
                ...
                <div
                  ...
                  "
                  aria-hidden="true"
                  id="headlessui-tabs-panel-:Rrb96:"
                  role="tabpanel"
                  tabIndex="{-1}"
                  data-headlessui-state
                  aria-labelledby="headlessui-tabs-tab-:Rmr96:"
                >
                  <div
                    class="w-[52.75rem] overflow-hidden rounded-xl bg-white shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10"
                  >
      ...
      >
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
          <div class="mx-auto max-w-lg text-center">
            <h2
              class="font-display text-3xl tracking-tight text-white sm:text-4xl"
            >
              Get started today
            </h2>
      ...
      >
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <section
              class="flex flex-col rounded-3xl px-6 sm:px-8 order-first bg-blue-600 py-8 lg:order-none"
            >
    ...
    <footer class="bg-slate-50">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="py-16">
          <div class="text-center text-lg">🚀 Rocket Rails</div>
        ...
        >
          <div class="flex gap-x-6">
            <a
              class="group"
              aria-label="Rocket Rails on Twitter"
            ...
            <a
              class="group"
              aria-label="Rocket Rails on GitHub"
          ...
          <p class="mt-6 text-sm text-slate-500 sm:mt-0">
            Copyright © 2023 Rocket Rails. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
