<template>
  <div class="flex h-full md:h-screen flex-col">
    <div class="relative flex h-full justify-center md:px-12 lg:px-0">
      <div
        class="relative z-10 flex flex-1 flex-col bg-white px-4 py-10 shadow-2xl sm:justify-center md:flex-none md:px-28"
      >
        <main
          class="mx-auto w-full max-w-md sm:px-4 md:w-96 md:max-w-sm md:px-0"
        >
          <div class="flex">
          ...
          <p class="mt-2 text-sm text-gray-700">
            Already registered?
            <a class="font-medium text-blue-600 hover:underline" href="/sign-in"
              >Sign in</a
            >
            to your account.
          </p>
          ...
          >
            ...
            <div class="col-span-full">
              ...
              ><select
                ...
                class="block w-full appearance-none rounded-md border border-gray-200 bg-gray-50 px-3 py-2 text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-blue-500 sm:text-sm pr-8"
              >
...
import BlueGradient from "@/assets/images/blueGradient.jpg";
