<template>
      ...
      <div class="ly cpy cqf crm cut cwo cyy">
        <div class="flex uo ym aao ade aff afp bg-white arf asp">
                  ...
                  <li v-for="route in routes" :key="route.name">
                    <nuxt-link
                      ...
                      :class="{
                        ...
                        'axo blb bic ': currentRoute.name != route.name,
                ...
                <ul role="list" class="fv kw abj">
                  <li v-for="team in teams" :key="team.name">
                    ...
                    >
                      ...
                      <span class="whitespace-nowrap overflow-hidden text-ellipsis">{{ team.name }}</span>
                    </a>
                  </li>
                </ul>
              </li>
              <li class="mt-auto">
                ...
                >
                  <svg
                    ...
                    stroke="currentColor"
                    aria-hidden="true"
                    class="w-6 h-6 shrink-0 axk brn"
                  >
                    <path
                      strokeLinecap="round"
