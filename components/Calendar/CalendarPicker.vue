<template lang="">
  <div ref="pickerComponentRef" class="w-fit">
    <div class="relative max-w-sm min-w-[350px]">
      <div
      ...
      <input
        ...
        type="text"
        class="bg-gray-50 h-[40px] border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full pl-[40px] p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <TransitionRoot
      ...
      <div class="px-4 pt-4 pb-2 mt-2 shadow-lg rounded-lg border">
